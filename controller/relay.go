...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.NewAPIError) {
	...
	oneCard429AutoDisabled := service.HandleOneCard429AutoDisable(c, channelError, err)
	if !oneCard429AutoDisabled && service.ShouldDisableChannel(err) && channelError.AutoBan {
		gopool.Go(func() {
